...
<html lang="en">
<head>
    <title>MARYS - Contratos en Validación</title>
    ...
    <meta name="author" content="CAE de Abasto Colima">
		        ...
		        <div class="app-header-content">
		            ...
		            <div class="app-search-box col">
		                <form class="app-search-form">
							<input type="text" placeholder="Buscar contrato..." name="search" class="form-control search-input">
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
    ...
    <div class="app-wrapper">
        ...
        <div class="tab-content pt-4" id="">
                    ...
                    <div class="app-card-body mb-3" style="padding:10px;">
                      <div style="padding-top:5px; padding-bottom:10px; color:#eebf41 !important">
                        <!--// #eebf41 #15a362-->
                        <h5 style="color:#15a362 !important">Nueva Solicitud de Validación</h5>
                      </div>
                      <?php
                      	...
                      	if(isset($_GET["identificador"]))
                      		...
                      		$identificador = 0;
                      ?>
                      <form class="settings-form" id="" method="POST" name="form" action="agregar.php">
                        <input type="hidden" name="identificador" value="<?php echo $identificador;?>">
                      	<input type="hidden" name="respuestas" value="<?php echo $respuestas;?>">
                        <div class="mb-3">
                          <label for="setting-input-1" class="form-label">Abogado que Elabora <span class="ml-2" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Abogado de la Oficina de Contratos que elabora el Instrumento Jurídico"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="red" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
      ...
      <circle cx="8" cy="4.5" r="1"/>
                      ...
                      <div class="mb-3">
                          <label for="setting-input-2" class="form-label">Contrato a validar
                            <span class="ml-2" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Es necesario que el contrato que se pretenda someter a validación se encuentre registrado previamente"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info-circle" fill="red" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
            <path d="M8.93 6.588l-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588z"/>
            <circle cx="8" cy="4.5" r="1"/>
            </svg></span>
                          ...
                          <select class="form-control" id="" name="titulo" onChange="" required>
                            <?php
      ...
      <textarea name="mensaje" class="form-control"  cols="50" rows="5" required></textarea>
            ...
            <div style="margin-top:-20px;">
              <input class='btn app-btn-primary' type="submit" id="submit" name="submit" value="Solicitar Validación">
              </form>
          </div>
        </div><!--//tab-content-->
      </div>
