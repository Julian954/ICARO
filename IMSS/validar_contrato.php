...
<body class="app">
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                      ...
                      <li class="submenu-item"><a class="submenu-link" href="contratos_cae.php">Validar Contrato</a></li>
                      <li class="submenu-item"><a class="submenu-link" href="contratos_cae.php">Pendientes de Firma</a></li>
...
<circle cx="8" cy="4.5" r="1"/>
                ...
                <div class="mb-3">
                    <label for="setting-input-3" class="form-label">Folio de Imperesión</label>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="status_contrato" name="status_contrato">
                      <option></option>
                      <option value="CC">Validado</option>
                    </select>
                </div>
                <button type="submit" class="btn app-btn-primary">Generar Folio</button>
                </form>
              </div><!--//app-card-body-->
				    </div><!--//app-card-body-->
