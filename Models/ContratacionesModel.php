...
class ContratacionesModel extends Mysql {
 ...
 public function datos_foro(){
     ...
     */
    public function agregarContratacion(string $oficio, string $administrador,string $descripcion, string $contratacion, string $area, string $contrato, string $termino, string $maximo, string $dictamen, string $nombre_archivo, string $inicio) {
        $return = "";
        $this->oficio = $oficio;
        ...
        if (empty($result)) {
            ...
            $query = "INSERT INTO contrataciones(NoOficio, Administrador, Descripcion, Contratacion, Area, Contrato, Termino, Maximo, Dictamen, Documento, Inicio) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            $data = array($this->oficio, $this->administrador, $this->descripcion, $this->contratacion, $this->area, $this->contrato, $this->termino, $this->maximo, $this->dictamen, $this->nombre_archivo, $this->inicio);
