...
class ContratacionesModel extends Mysql {
 ...
 public function datos_foro(){
     ...
     */
    public function agregarContratacion(string $NoOficio,string $Administrador,string $Descripcion,string $Contratacion,string $Area,string $Contrato,string $Termino,string $Maximo,string $Dictamen,string $Documento,string $Inicio) {
        $return = "";
        $this->numero = $NoOficio;
        ...
        $sql = "SELECT * FROM contrataciones WHERE numero = '{$this->numero}'";
