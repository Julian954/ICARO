    ...
    <div class="app-wrapper">
        ...
        <?php
          ...
          while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ...
            echo "<div class='app-card shadow-sm h-100' style='margin-top:20px !important;'>
              <div class='app-card-body p-3 p-lg-4'>
                <div><h4 style='color:'>".$titulo."</h4></div>";
            echo "<div class='sstats-meta text-success'>".$autor."</div>";
            echo "<div class='sstats-meta intro'>".$mensaje."</div>";
            echo "<div class='sstats-meta' style='color:#000000; font-size:10px;'>".$fecha."</div>";
            echo "<div style='margin-top:15px; margin-bottom: 30px;'><div style='height:12px !important;'><a href='contratosWord/".$titulo."pdf' class='btn-sm app-btn-secondary' style='background-color:#F7DC6F; font-weight: bold; font-size:12px;' href=''>".$titulo."_val.docx</a></div></div>";
            echo "</div><!--//app-card-body-->
              <a class='app-card-link-mask' href='#'></a>
            </div><!--//app-card-->";
            echo "<br /><a href='formulario_rev_contrato.php?id&respuestas=$respuestas&identificador=$id'>Responder Aqui</a><br />";
          }
          echo "<div class='app-card shadow-sm h-100' style='margin-top:20px !important;'>
              <div class='app-card-body p-3 p-lg-4'>
                <div>
          ...
          while($row = mysqli_fetch_array($result2, MYSQLI_ASSOC)){
            ...
            echo "<div class='mb-3'>";
            echo "<div style='font-size:14px; color:#5cb377;>".$titulo."</div>";
            echo "<div style='font-size:12px;'>".$autor."</div>";
            echo "<div style='font-size:14px; color:#000000;'>".$mensaje."</div>";
            echo "<div class='sstats-meta' style='color:#000000; font-size:10px;'>".$fecha."</div>";
            echo "</div>";
          }
        ?>
