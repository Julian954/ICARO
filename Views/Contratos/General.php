                ...
                <div class="app-card app-card-notification shadow-sm">
                    <div class="app-card-header px-4 py-3">
                        <div class="row g-3 align-items-center">
                            ...
                            <div>
                              <span style="font-weight:bold;">Total de Instrumentos:</span>&nbsp<span style="font-weight:bold; text-decoration:solid underline #5B99EA 2px;"><?php echo $data3[0]['total']; ?></span>                       
                              </span>&nbsp<span>a un ascendente de: </span>&nbsp<span style="font-weight:bold;">$<?php echo number_format($data3[0]['maximo'], 2); ?></span>
                            </div>
                          <div>
