...
<!--Agregar el archivo para usar el controlador y guardarlo en BD-->        
    ...
    <div class="modal fade" id="VentanaModal" tabindex="-1" role="dialog" aria-labelledby="TituloVentana" aria-hidden="true">
              <div class="dialog-modal" rol="document">
            <div class="modal-content">
            <h4 class="modal-title" id="TituloVentana"><i class="fas fa-plus-circle"></i>Cargar Datos</h4>
...
<!--Agregar el archivo para usar el controlador y guardarlo en BD-->        
    <div>
      ...
      <input type="file" name="archivo" value=""/>
                  ...
                  <button type="submit" class="btn app-btn-primary" dismiss="modal">Cargar</button>
                  <button  style="color:#ffffff" type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fas fa-window-close"></i>Cerrar</button>
                </form>               
              </div><!--//app-card-body-->
				    </div><!--//app-card-body-->
    </div></div>
