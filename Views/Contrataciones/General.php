        ...
        <div class="row g-4 mb-4">
              ...
              <div class="row g-4 mb-4" style="padding-top:10px; font-size:14px;">
                  <div class="col-12 col-lg-12" style="color:#000000;">
                    <div class="item-data"><strong style="font-size:16px">En general tenemos:</strong></div>
										<div class="item-label mb-2">
                      <br>
                        <span style="text-decoration:solid underline #5B99EA 2px;"><strong><?php echo $data6['total']; ?></strong></span>
                         Instrumentos, lo cual nos da un ascendente de
                        <span style="text-decoration:solid underline #5B99EA 2px;"><strong>$<?php echo number_format($data6['maximo'], 0); ?> MXN.</span></strong>
              <div class="item-data"><br>De los <strong><?php echo $data6['total']; ?></strong> Instrumentos</div>
										<div class="item-label mb-2">
                        ...
                        <?php foreach ($data2 as $ctr) { ?>
                          ...
                          <?php foreach ($data3 as $cov) { 
                            ...
                            <strong><span style="font-weight:lighter; color:#2980B9; font-size:12px;">(<?= $cov['contrato'].': '.$cov['total'];?>)</span></strong>
                          <?php }} ?><br>
                        <?php } ?>
                      </strong><br>
                    </div>
                    ...
                    <tbody>
                      <strong>
                        ...
                        <?php if ($cn['estado'] == 1) { ?>                                                    
                          ...
                          <td>
                          <strong><span style="font-weight:semibold; color:#E74C3C; font-size:12px;">(<?php echo number_format($cn['total']*100/$data6['total'],2); ?>%)</span></strong><br>
                          </td>
                        </tr>                        
                          <?php } ?>
                      </strong>
