    ...
    <div class="app-wrapper">
	    <div class="app-content pt-3 p-md-3 p-lg-4">
          ...
          <div class="" id="faq2-heading-1">
                  ...
                  <!--error en el rol, trato de entrar como gerente con rol 3 pero muestra rol 6-->
				    		    ...
				    		    <div class="app-card-body">
				    			    <div class="table-responsive">
				    			      <table class="table app-table-hover mb-0 text-left" id="Table">				    						  
				    						  <tbody>
          <!--Compara en la BD que existan datos en los comentarios entre las personas que se relacionan en el contrato seleccionado-->
                            <?php foreach ($data2 as $validar) { ?>
                              <?php if($data1['id_contrato']==$validar['observacion']){?>
				    						    	<tr>
                                <?php if($validar['respuesta']!="" || $validar['descripcion']!=""){?>
                                <?php if($validar['respuesta']==""){?>                                                                
                                <td><b style="text-transform: uppercase;"><?php  echo $validar['nombre_externo']; ?></b></td>
                                <td><?php echo  $validar['descripcion'];?></td>    
                                <th><a href="<?php echo base_url(); ?>Contratos/get_pdf?=<?php echo $validar['archivo']; ?>"><?php echo $validar['archivo']; ?></a></th> 
                                <?php } else?>  
                                <?php if($validar['descripcion']==""){?>        
                                  <td><b style="text-transform: uppercase;"><?php  echo $validar['nombre_interno'];?></b></td>
                                <td><?php echo  $validar['respuesta'];?></td>  
                                <th><a href="<?php echo base_url(); ?>Contratos/get_pdf?=<?php echo $validar['archivo']; ?>"><?php echo $validar['archivo']; ?></a></th>
                                <?php } ?>  
				    						    	</tr>
                              <?php }?>
