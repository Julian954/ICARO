	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
              ...
              <div class="app-card-body">
                <form method="POST" action="php/agregaNuevoDevengo.php">
                  <div class="mb-3">
...
<select class="form-control" id="no_contrato" name="no_contrato" onChange="">
  <?php
                ...
                <div class="mb-3">
                    <label for="setting-input-2" class="form-label">Monto a Devengar</label>
                    <input type="float" class="form-control" id="devengo_contrato" name="devengo_contrato" value="" required>
                </div>
                <div class="mb-3">
                    <label for="setting-input-2" class="form-label">Servicio devengado</label>
                    <input type="text" class="form-control" id="concepto_devengo" name="concepto_devengo" value="" required>
                </div>
                <div class="mb-3">
                    <label for="setting-input-2" class="form-label">Unidad del cargo</label>
                    <input type="text" class="form-control" id="unidad_contrato" name="unidad_contrato" value="" required>
                </div>
                <div class="mb-3">
                    <label for="setting-input-2" class="form-label">Fecha del Servicio</label>
                    <input type="date" class="form-control" id="fecha_devengo" name="fecha_devengo" value="" required>
                </div>
    ...
    <script>
          $(document).ready(function() {
              $("#showCostoPartida").val('');
          });
          function imprimeProveedor() {
              var textoBusqueda = $("select#numeroContrato").val();

               if (textoBusqueda != "") {
                  $.post("php/buscaNombreProveedor.php", {valorBusqueda: textoBusqueda}, function(mensajeCosto) {
                      $("#showCostoPartida").val(mensajeCosto);
                   }
  				 );
               } else {
                  $("#showCostoPartida").val('Sin Resultados');
                  };
